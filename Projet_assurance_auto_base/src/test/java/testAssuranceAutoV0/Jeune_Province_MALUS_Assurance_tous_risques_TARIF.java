...
public class Jeune_Province_MALUS_Assurance_tous_risques_TARIF {
    ...
    public Jeune_Province_MALUS_Assurance_tous_risques_TARIF(final String Vehicule_carburant, final String Vehicule_marque, final String Vehicule_modele) {
